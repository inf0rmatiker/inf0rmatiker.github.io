...
Install the remaining dependencies for compiling the Lustre client:
...
View https://docs.nvidia.com/networking/display/MLNXOFEDv461000/Installing+Mellanox+OFED[Nvidia's Installing Mellanox OFED] or my xref:docs-site:learning:/infiniband/infiniband#_mofed_installation[InfiniBand MOFED Installation notes] for more in-depth information. Below is a brief synopsis of the install process.

...
image::docs-site:blog:image$vu-meter/vu_meter_osc_only.png[vu meter oscilloscope only]
...
image::docs-site:blog:image$vu-meter/60_hz_clean.png[60 Hz clean sine wave]
...
image::docs-site:blog:image$vu-meter/normal_sine_wave.png[normal sine wave]

to, after rectification,

image::docs-site:blog:image$vu-meter/abs_sine_wave.png[abs sine wave]
...
image::docs-site:blog:image$vu-meter/vu_meter_with_rectifier.png[vu meter with rectifier]

And a physical view of my breadboard circuit:

image::docs-site:blog:image$vu-meter/breadboard_1.png[breadboard 1]
...
image::docs-site:blog:image$vu-meter/osc_rectified_1.jpeg[osc rectified 1]

Over a period of about 20 seconds, the signal gets worse and worse, and slowly devolves:

image::docs-site:blog:image$vu-meter/osc_rectified_2.jpeg[osc rectified 2]

image::docs-site:blog:image$vu-meter/osc_rectified_3.jpeg[osc rectified 3]

image::docs-site:blog:image$vu-meter/osc_rectified_4.jpeg[osc rectified 4]
